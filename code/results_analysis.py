...
model_normal = load_model("models+weights/cnn_model_normal_data.json", "models+weights/cnn_model_normal_data_weights.hdf5")
model_augmented = load_model("models+weights/cnn_model_50%_confounded.json", "models+weights/cnn_model_50%_confounded_weights.hdf5")
...
plot_side_by_side(
    ...
    base_dir="../datasets/gmi/test_jpg",
    csv_path="../results/gmi_results_50%_test_normal.csv",
    model1=model_normal,
